...
c4 = Channel.create!(name: 'slap-talk', description: 'Hand in your best hand-related puns' )
...
Message.create!(author_id: u5.id, channel_id: c2.id, body: "what is the sound of one hand clapping")
