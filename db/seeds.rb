...
Message.create!(author_id: u1.id, channel_id: c1.id, body: "hey")
Message.create!(author_id: u2.id, channel_id: c1.id, body: "hello!")
Message.create!(author_id: u1.id, channel_id: c2.id, body: "hi")
Message.create!(author_id: u1.id, channel_id: c2.id, body: ":D")
